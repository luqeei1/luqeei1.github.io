    ...
    >
      ...
      <div className="flex flex-col items-center lg:items-center mt-4">
          ...
          >
            ...
            <span className="bg-gradient-to-r from-blue-300 via-purple-500 to-pink-500 bg-clip-text text-transparent border-b-4 font-bold bg-gradient-to-r from-blue-300 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-lg ">
              <Typewriter
